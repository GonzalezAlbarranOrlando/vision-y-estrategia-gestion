      ...
      <div class="col-sm-6 py-2">
        ...
        <div class="card">
          ...
          <div class="card-body ext-box" style="min-height: 300px;">
            <div class="int-box"> 
              <h3 class="my-h3">
                INFORME DE CENTROS DE TRABAJO QUE HAN IMPLEMENTADO LA NORMA OFICIAL MEXICANA NOM-035-STPS-2018 FACTORES DE RIESGOS PSICOSOCIALES EN EL TRABAJO-IDENTIFICACIÓN, ANÁLISIS Y PREVENCIÓN.
              </h3>
            </div>
          </div>
        </div>
