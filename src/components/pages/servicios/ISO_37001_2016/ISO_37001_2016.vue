<template>
  <div class="container">
    ...
    <div class="my-5" v-if="selected_opt_ISO_37001_2016 === 'enqueconsiste'">
      <EnQueConsiste />
    </div>
    <div
      class="my-5"
      v-if="selected_opt_ISO_37001_2016 === 'serviciodeimplantacion'"
    >
      <ServicioDeImplantacion />
    </div>
    <div class="my-5" v-if="selected_opt_ISO_37001_2016 === 'capacitacion'">
      <Capacitacion />
    </div>
