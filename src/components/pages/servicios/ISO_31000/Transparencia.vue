    ...
    <div class="row justify-content-center">
      <div class="col-12 col-md-11 col-xl-5 py-2">
        ...
        <div class="card">
          ...
          <div class="card-body ext-box" style="min-height: 370px;">
            <div class="int-box">
            ...
            <div class="int-box">
              ...
              <div class="general-text">
                <p>
                  ...
                  <a
                      class="download-here"
                      href="/docx/Contrato de prestación de servicios 31000.docx"
                      target="_blank"
                    >
                      aquí </a
                    >.
      ...
      <div class="col-12 col-md-11 col-xl-5 py-2">
        ...
        <div class="card">
          ...
          <div class="card-body ext-box" style="min-height: 230px;">
            <div class="int-box">            
              ...
              <div class="general-text">
                <p>
                  ...
                  <a
                      class="download-here"
                      href="/docx/procedimiento de quejas 31000.docx"
                      target="_blank"
                    >
                      aquí </a
                    >.
