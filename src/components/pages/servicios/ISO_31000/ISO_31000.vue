<template>
  <div class="container">
    ...
    <select
      ...
      v-model="selected_opt_ISO_31000"
    >
    ...
    <div class="my-5" v-if="selected_opt_ISO_31000 === 'enqueconsiste'">
      <EnQueConsiste />
    </div>
    <div
      class="my-5"
      v-if="selected_opt_ISO_31000 === 'serviciodeimplantacion'"
    >
      <ServicioDeImplantacion />
    </div>
    <div class="my-5" v-if="selected_opt_ISO_31000 === 'consultoria'">
      <Consultoria />
    </div>
    <div class="my-5" v-if="selected_opt_ISO_31000 === 'capacitacion'">
      <Capacitacion />
    </div>
...
export default {
  ...
  data() {
    return {
      selected_opt_ISO_31000: "enqueconsiste",
    };
  },
  components: {
    EnQueConsiste,
